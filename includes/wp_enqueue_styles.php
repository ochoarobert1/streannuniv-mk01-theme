...
function streannuniv_load_css() {
    ...
    if (!is_admin()){
        ...
        /*- GOOGLE FONTS -*/
        wp_register_style('google-fonts', 'https://fonts.googleapis.com/css?family=Yantramanav:100,300,400,500,700,900', false, $version_remove, 'all');
        wp_enqueue_style('google-fonts');

        /*- MAIN STYLE -*/
        wp_register_style('main-style', get_template_directory_uri() . '/css/streannuniv-style.css', false, $version_remove, 'all');
        wp_enqueue_style('main-style');

        /*- MAIN MEDIAQUERIES -*/
        wp_register_style('main-mediaqueries', get_template_directory_uri() . '/css/streannuniv-mediaqueries.css', array('main-style'), $version_remove, 'all');
...
add_action('wp_enqueue_scripts', 'streannuniv_load_css');
